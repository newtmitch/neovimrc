...
-- rsm: default file browser (until I find a better one)
vim.keymap.set('n', '<leader>pv', vim.cmd.Ex, { desc = 'Open default file browser' })

-- rsm: Neotree shortcut
...
-- rsm: center the cursor on C-d/u and n/N for searching
...
-- cutting to the end of a line shouldn't overwrite the buffer
